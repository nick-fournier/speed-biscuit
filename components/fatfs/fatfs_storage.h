...
#define SPI_SPEED_DEFAULT 3000 * 1000 // Default speed: 3 MHz
#define SPI_SPEED_MEDIUM 15 * 1000 * 1000 // Medium speed: 15 MHz
#define SPI_SPEED_HIGH 30 * 1000 * 1000 // High speed: 30 MHz
...
extern esp_err_t SPI_Set_Speed(uint32_t speed_hz);
